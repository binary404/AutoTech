...
public class RenderDisplayStand extends TileEntityRenderer<TileDisplayStand> {
    ...
    @Override
    public void render(TileDisplayStand tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
