package binary404.autotech.client.render;
...
public class ItemPipeRenderer extends TileEntityRenderer<TileItemPipe> {

    public ItemPipeRenderer(TileEntityRendererDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    @SuppressWarnings("deprecation")
    public void render(TileItemPipe tile, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer bufferType, int combinedLight, int combinedOverlay) {
