...
public class GuiDistillery extends GuiEnergy<TileDistillery, ContainerDistillery> {

    public GuiDistillery(ContainerDistillery container, PlayerInventory inv, ITextComponent title) {
        super(container, inv, title, Texture.DISTILLERY);
    }
    ...
    public void drawExtraText(MatrixStack matrix, int mouseX, int mouseY) {
        if (this.isMouseOver(mouseX, mouseY, 14, 62, this.guiLeft + 44, this.guiTop + 5)) {
