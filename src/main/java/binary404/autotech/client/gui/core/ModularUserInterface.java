...
import binary404.autotech.client.gui.core.widget.*;
...
public class ModularUserInterface implements ISizeProvider {
    ...
    public ModularUserInterface(ImmutableBiMap<Integer, Widget> guiWidgets, ImmutableList<Runnable> openListeners, ImmutableList<Runnable> closeListeners, TextureArea backgroundPath, int width, int height, IUIHolder holder, PlayerEntity player) {
    ...
    public static class Builder {
        ...
        public Builder bindPlayerInventory(PlayerInventory inventoryPlayer, int startY) {
            bindPlayerInventory(inventoryPlayer, GuiTextures.SLOT, 8, startY);
            return this;
        }

        public Builder bindPlayerInventory(PlayerInventory inventoryPlayer, TextureArea imageLocation) {
            return bindPlayerInventory(inventoryPlayer, imageLocation, 8, 84);
        }

        public Builder bindPlayerInventory(PlayerInventory inventoryPlayer, TextureArea imageLocation, int x, int y) {
        ...
        public Builder bindPlayerHotbar(PlayerInventory inventoryPlayer, TextureArea imageLocation, int x, int y) {
        ...
        public ModularUserInterface build(IUIHolder holder, PlayerEntity player) {
            return new ModularUserInterface(widgets.build(), openListeners.build(), closeListeners.build(), background, width, height, holder, player);
        }
    }
}
