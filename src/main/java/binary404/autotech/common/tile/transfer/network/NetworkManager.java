...
public class NetworkManager extends WorldSavedData {
    ...
    private static final String NAME = AutoTech.modid + "_networks";
    private static final Logger LOGGER = LogManager.getLogger("AutoTech-NetworkManager");
    ...
    public void read(CompoundNBT tag) {
        ...
        for (INBT pipeTag : pipes) {
            ...
            // @BC
            ResourceLocation factoryId = pipeTagCompound.contains("id") ? new ResourceLocation(pipeTagCompound.getString("id")) : new ResourceLocation(AutoTech.modid, "item");
