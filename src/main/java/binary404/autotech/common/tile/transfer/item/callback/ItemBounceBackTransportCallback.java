package binary404.autotech.common.tile.transfer.item.callback;

import binary404.autotech.AutoTech;
import binary404.autotech.common.tile.transfer.network.Network;
import binary404.autotech.common.tile.transfer.pipe.item.TransportCallback;
...
public class ItemBounceBackTransportCallback implements TransportCallback {
    ...
    public static final ResourceLocation ID = new ResourceLocation(AutoTech.modid, "item_bounce_back");
