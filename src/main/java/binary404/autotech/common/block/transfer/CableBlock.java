...
import binary404.autotech.common.tile.transfer.CableNetworkManager;
...
public class CableBlock extends SixWayBlock {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new CableTileEntity(tier);
    }
    ...
    private static ConnectionType createConnection(IBlockReader worldIn, BlockPos pos, Direction side, ConnectionType current) {
        ...
        if (tileEntity instanceof CableTileEntity) {
            ...
            IEnergyStorage energy = binary404.autotech.common.core.util.Util.getEnergyFromSideOrNull(tileEntity, side.getOpposite());
            if (energy != null) {
    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
        if (worldIn.getTileEntity(facingPos) instanceof CableTileEntity)
