...
import binary404.autotech.common.block.transfer.shape.PipeShapeProps;
import binary404.autotech.common.block.transfer.shape.Raytracer;
import binary404.autotech.common.item.AttachmentItem;
...
public abstract class BlockPipe extends Block {
    ...
    public BlockPipe(PipeShapeCache shapeCache) {
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
        ...
        if (dirClicked != null) {
            ...
            } else if (tile instanceof TilePipe && ((TilePipe) tile).getAttachmentManager().hasAttachment(dirClicked)) {
                return openAttachmentContainer(player, pos, ((TilePipe) tile).getAttachmentManager(), dirClicked);
    ...
    private ActionResultType removeAttachment(World world, BlockPos pos, Direction dir) {
        if (!world.isRemote) {
            ...
            return ((TilePipe) world.getTileEntity(pos)).getAttachmentManager().hasAttachment(dir) ? ActionResultType.SUCCESS : ActionResultType.FAIL;
        }
    }
    ...
    public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
        ...
        if (dirClicked != null) {
            ...
            if (tile instanceof TilePipe) {
                return ((TilePipe) tile).getAttachmentManager().getPickBlock(dirClicked);
            }
        }
