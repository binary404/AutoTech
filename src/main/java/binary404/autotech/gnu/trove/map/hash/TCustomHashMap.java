...
import binary404.autotech.gnu.trove.impl.hash.TCustomObjectHash;
import binary404.autotech.gnu.trove.iterator.hash.TObjectHashIterator;
import binary404.autotech.gnu.trove.map.TMap;
import binary404.autotech.gnu.trove.procedure.TObjectObjectProcedure;
import binary404.autotech.gnu.trove.procedure.TObjectProcedure;
import binary404.autotech.gnu.trove.strategy.HashingStrategy;
...
public class TCustomHashMap<K, V> extends TCustomObjectHash<K>
    ...
    private final class HashProcedure implements TObjectObjectProcedure<K, V> {
        ...
        public final boolean execute( K key, V value ) {
            h += gnu.trove.impl.HashFunctions.hash( key ) ^ ( value == null ? 0 : value.hashCode() );
            return true;
        }
    }
