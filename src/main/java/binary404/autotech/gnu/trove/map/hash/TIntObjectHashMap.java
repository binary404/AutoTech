...
package binary404.autotech.gnu.trove.map.hash;

import binary404.autotech.gnu.trove.TIntCollection;
import binary404.autotech.gnu.trove.function.TObjectFunction;
import binary404.autotech.gnu.trove.impl.hash.THashPrimitiveIterator;
import binary404.autotech.gnu.trove.impl.hash.TIntHash;
import binary404.autotech.gnu.trove.iterator.TIntIterator;
import binary404.autotech.gnu.trove.iterator.TIntObjectIterator;
import binary404.autotech.gnu.trove.map.TIntObjectMap;
import binary404.autotech.gnu.trove.procedure.TIntObjectProcedure;
import binary404.autotech.gnu.trove.procedure.TIntProcedure;
import binary404.autotech.gnu.trove.procedure.TObjectProcedure;
import binary404.autotech.gnu.trove.set.TIntSet;
...
public class TIntObjectHashMap<V> extends TIntHash implements
    ...
    public TIntObjectHashMap( int initialCapacity ) {
        ...
        no_entry_key = gnu.trove.impl.Constants.DEFAULT_INT_NO_ENTRY_VALUE;
    }
   ...
   public int[] keys( int[] dest ) {
    ...
    public int hashCode() {
        ...
        for ( int i = values.length; i-- > 0; ) {
            if ( states[i] == FULL ) {
                hashcode += gnu.trove.impl.HashFunctions.hash( _set[i] ) ^
