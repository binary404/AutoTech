...
package binary404.autotech.gnu.trove.list.linked;
...
public class TIntLinkedList implements TIntList, Externalizable {
   ...
   /**
    ...
    @Override
    public int hashCode() {
        int result = gnu.trove.impl.HashFunctions.hash(no_entry_value);
        result = 31 * result + size;
        for (TIntIterator iterator = iterator(); iterator.hasNext();) {
            result = 31 * result + gnu.trove.impl.HashFunctions.hash(iterator.next());
        }
